...
/***/ function(module, exports, __webpack_require__) {
	...
	var _avatar = __webpack_require__(354);

	var _avatar2 = _interopRequireDefault(_avatar);

	var _skills = __webpack_require__(357);
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						{ className: 'col s6' },
						_react2.default.createElement(_avatar2.default, { source: 'https://api.github.com/users/kiramishima' })
					),
					_react2.default.createElement(
						'div',
						{ className: 'col s6 m6' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(9)(IteratorPrototype, __webpack_require__(34)('iterator'), function () {
	  return this;
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, (function() { return this; }()), __webpack_require__(191)(module), __webpack_require__(192)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".Application {\n  background: yellow; }\n", ""]);
						...
						while (1) {
							switch (_context.prev = _context.next) {
								case 0:
									console.log(1222);
									_context.next = 3;
									return fetch(_this2.props.source);
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement('img', { alt: this.state.name, src: this.state.avatar_url })
					)
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Skill = exports.Skill = function (_Component) {
		...
		_createClass(Skill, [{
			...
			value: function render() {
				return _react2.default.createElement(
					"div",
					{ className: "chip", onClick: this.skill.bind(this) },
					_react2.default.createElement("img", { src: this.props.src, alt: "Contact Person" }),
					" ",
					this.props.name
				);
			}
	...
	var Skills = function (_Component2) {
		...
		function Skills(props) {
			...
			var _this2 = _possibleConstructorReturn(this, Object.getPrototypeOf(Skills).call(this, props));
		...
		_createClass(Skills, [{
			...
			key: "render",
			value: function render() {
				var items = this.state.skills.map(function (item) {
					return _react2.default.createElement(Skill, { key: item.name, name: item.name, src: item.logo });
				});
				return _react2.default.createElement(
					"div",
					{ className: "skills" },
